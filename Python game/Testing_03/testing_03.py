                ...
                if self.tilemap.solid_check(projectile[0]):
                    ...
                    if self.player.rect().collidepoint(projectile[0]):
                        ...
                        for i in range(30):
                            ...
                            self.particles.append(Particle(self, 'particle', self.player.rect().center, velocity=[math.cos(angle + math.pi) * speed * 0.5, math.sin(angle + math.pi) * 0.5], frame=random.randint(0,7)))
